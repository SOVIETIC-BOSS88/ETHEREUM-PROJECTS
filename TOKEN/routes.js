...
///////
 ...
 // Get the receipt number and check it on the back end
 router.route('/tokens').post(function (req, res) {

   var receiptNumber = req.body.receiptNumber;
   var metamaskAddress = req.body.metamaskAddress;
   res.send(receiptNumber);
   res.send(metamaskAddress);
 });
/////
...
/**
 * token_server.js
 * Stripe Payments Demo. Created by Suren Harutyunyan.
 *
 * Simple receive methods to validate a receipt_id, validate it and send the token.
 * The methods use the Stripe API and the web.js API.
 * We validate the receipt_id against an array of receipt_ids to avoid double spend,
 * and send the token respectively, depending on the quantity of the order.
 */
...
// Requires for the web3 and to get the injected web3 instance
//var Web3 = require('web3');

/*
// This is for injected web3 instance detection
...
///////
//THESE ARE THE REQUIRES WE HAVE TO CHANGE FOR THE WEB3 and the contracts
